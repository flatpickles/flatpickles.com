...
I have printed stickers stickers with a pithy description of this practice, and I've started distributing these stickers to my people. We can put the stickers inside the books we love, and start writing our names next to them. Here's the sticker design:

<img src="/img/bp-final.png" alt="Book Pass Sticker Draft" style="width: 100%; max-width: 400px;"/>
...
I’ll post an update here if/when I make these stickers available for purchase, but you might as well pass a book to someone in the meantime. Maybe they’ll read it, love it, and pass it forward.
